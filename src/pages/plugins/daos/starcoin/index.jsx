          ...
          <div className='col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 d-flex align-items-stretch'>
            <div className='card full-width'>
              <div className='card-body'>
                ...
                <button
                  className='btn btn-primary btn-lg btn-block mb-3'
                  id='resolveModuleButton'
                >
                  Resolve Functions
                </button>
                <h4 className='card-title'>Module Functions:</h4>
                <p
                  id='resolveResultView'
                  className='info-text alert alert-warning'
                >
          ...
          <div className='col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 d-flex align-items-stretch'>
            <div className='card full-width'>
              <div className='card-body'>
                ...
                <button
                  className='btn btn-primary btn-lg btn-block mb-3'
                  id='autoAcceptTokenOn'
                >
                  Turn On
                </button>
                <button
                  className='btn btn-primary btn-lg btn-block mb-3'
                  id='autoAcceptTokenOff'
                >
                  Turn Offf
                </button>
                <p className='info-text alert alert-warning'>
