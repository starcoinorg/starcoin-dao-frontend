...
import {Flex, Button, HStack, Stack, Tag, Text, Link, Heading, Spacer} from '@chakra-ui/react';
        ...
        <ContentBox>
            <Stack spacing={4}>
                ...
                <Flex as={HStack} spacing={2} align='right'>
                    ...
                    {
                        installed ? (
                            <Button size='sm' minW='4rem' disabled={true} onClick={onUninstallPlugin}>
                                Uninstall
                            </Button>
                        ) : (
